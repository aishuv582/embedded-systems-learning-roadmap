/*
Program Name : tensdigitusing3digit.c
Author       : Aishwarya V
Description  : Program about printing ten's digit in a given 3 digit number
*/
#include<stdio.h>
...

{
	...
	printf("Ten's digit = %d", (x%100)/10);			//print tens digit
